...
}var $author$project$Main$OnUrlChanged = function (a) {
	return {$: 'OnUrlChanged', a: a};
};
var $author$project$Main$OnUrlRequested = function (a) {
...
var $author$project$Context$Context = F4(
...
var $author$project$Route$LoginRoute = {$: 'LoginRoute'};
var $author$project$Route$NotFoundRoute = {$: 'NotFoundRoute'};
var $author$project$Route$fromString = function (url) {
	switch (url) {
		case '/login':
			return $author$project$Route$LoginRoute;
		case '/home':
			return $author$project$Route$DashboardRoute;
		default:
			return $author$project$Route$NotFoundRoute;
	}
};
var $author$project$Pages$Dashboard$Model = F2(
...
var $author$project$Main$encodeLoginRequest = function (data) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'username',
				$elm$json$Json$Encode$string(data.username)),
				_Utils_Tuple2(
				'password',
...
var $author$project$Main$LoginResponseData = F2(
	...
	function (ctx, msg, model) {
		switch (msg.$) {
			case 'Login':
				return _Utils_Tuple2(
					model,
					$author$project$Pages$Login$postLogin(
	...
	function (msg, model) {
		...
		switch (_v0.a.$) {
			case 'OnUrlChanged':
				...
				switch (_v1.$) {
					case 'NotFoundRoute':
						var _v2 = $author$project$Pages$NotFound$init(model.ctx);
						var pModel = _v2.a;
						var cmd = _v2.b;
						return _Utils_Tuple2(
							_Utils_update(
				...
				if (req.$ === 'Internal') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{ctx: ctx}),
						A2($elm$browser$Browser$Navigation$pushUrl, ctx.key, url.path));
				} else {
					var url = req.a;
					return _Utils_Tuple2(
						model,
				...
				if (_v0.b.$ === 'Dashboard') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								pageModel: $author$project$Main$Dashboard(lmodel)
							}),
						A2(
							$author$project$Main$signalToCmd,
							model,
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('flex gap-4 items-center justify-center')
						]),
					_List_fromArray(
						[
							A2(
								...
								[
									...
									_List_fromArray(
										[
											...
											$author$project$Route$toString($author$project$Route$LoginRoute))
										]),
									_List_fromArray(
										[
	...
	function (ctx, model) {
		return {
			body: _List_fromArray(
				[
					$author$project$Components$viewHeader,
					A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text('Dashboard page')
						]))
				]),
...
var $author$project$Components$primaryBtnClass = 'bg-green-500 rounded-md py-3 px-5 text-white cursor-pointer hover:bg-green-600';
var $author$project$Components$viewButtonPrimary = function (data) {
	return A2(
		$elm$html$Html$button,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class($author$project$Components$primaryBtnClass),
				$elm$html$Html$Attributes$id(data.id),
				$elm$html$Html$Attributes$name(data.name),
				data.event
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(data.text)
			]));
};
var $author$project$Components$inputTextClass = 'bg-white rounded-md py-3 px-3 text-black border-black border-1';
var $author$project$Components$viewTextInput = function (data) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$type_(data.inputType),
				$elm$html$Html$Attributes$class($author$project$Components$inputTextClass),
				$elm$html$Html$Attributes$id(data.id),
				$elm$html$Html$Attributes$name(data.name),
				data.inputEvent,
								...
								[
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('grid gap-2')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															$author$project$Components$viewTextInput(
															{
																id: 'username',
																inputEvent: $elm$html$Html$Events$onInput($author$project$Pages$Login$UsernameChanged),
																inputType: 'text',
																name: 'username',
												...
												[
													...
													_List_fromArray(
														[
															...
															{
																id: 'password',
																inputEvent: $elm$html$Html$Events$onInput($author$project$Pages$Login$PasswordChanged),
																inputType: 'password',
																name: 'password',
		...
		case 'Dashboard':
			...
			return {
				body: A2(
					$elm$core$List$map,
					function (a) {
						return A2($elm$html$Html$map, $author$project$Main$DashboardMsg, a);
					},
					pview.body),
				title: pview.title
			};
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		onUrlChange: $author$project$Main$OnUrlChanged,
		onUrlRequest: $author$project$Main$OnUrlRequested,
